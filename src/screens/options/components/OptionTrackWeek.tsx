...
export function OptionTrackWeek() {
  ...
  async function loadBatchIds() {
    try {
      const res = await optionTrackWeekService.getBatchIds();
  ...
  async function fetchFresh() {
    ...
    setLoading(true);
    try {
      const res = await optionTrackWeekService.fetchFresh(expiryDate.trim());
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              const res = await optionTrackWeekService.deleteBatch(selectedBatch);
  ...
  return (
    ...
    >
      <CollapsibleCard title="Option Track Week">
